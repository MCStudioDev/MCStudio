...
const buildContentSecurityPolicy = (): string => {
  const directives = [
    ...
    "img-src 'self' data: blob: https://images.unsplash.com https://upload.wikimedia.org https://images.pexels.com https://lh3.googleusercontent.com https://*.googleusercontent.com https://firebasestorage.googleapis.com",
