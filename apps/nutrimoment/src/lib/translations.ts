...
export const translations = {
  en: {
    ...
    pescatarianDesc: "No meat, fish & seafood allowed",
    vegan: "Vegan",
    ...
    dairyFreeDesc: "No milk, cheese, butter, eggs",
    diabetes: "Diabetes",
    ...
    freePlanScanner: "Free plan: each scan, recipe generation, or weekly plan uses one of 10 shared AI credits and runs the complete workflow. {remaining}/{limit} credits remain.",
    ...
    freeMealPlanNotice: "A weekly plan uses one shared AI credit and includes the complete planning and image workflow.",
    ...
    aiCreditsExhausted: "AI credits used",
    ...
    legalBannerText: "Recipes and meal plans are guidance and may not be 100% accurate. Verify allergens, nutrition, and food safety before relying on them.",
    dismissLegalNotice: "Dismiss legal notice",
    importantSafetyNotice: "Important safety notice",
    recipeSafetyNotice: "Recipes are guidance and may not be 100% accurate. Generated results may miss allergens, substitutions, ingredient amounts, cooking times, safe temperatures, or nutrition values. Review every ingredient and step before preparing food.",
    mealPlanSafetyNotice: "Meal plans and their recipes are guidance and may not be 100% accurate. They reflect saved preferences and pantry matches, but they are not individualized medical nutrition therapy. Review portions, allergies, medications, pregnancy, pediatric, and disease-specific needs with a qualified clinician.",
  ...
  ar: {
    ...
    dairyFreeDesc: "بدون حليب، جبن، زبدة، بيض",
    diabetes: "السكري",
  ...
  es: {
    ...
    pescatarianDesc: "Sin carne, pescado y mariscos permitidos",
    vegan: "Vegano",
    ...
    dairyFreeDesc: "Sin leche, queso, mantequilla, huevos",
    diabetes: "Diabetes",
  ...
  fr: {
    ...
    pescatarianDesc: "Pas de viande, poisson et fruits de mer autorisés",
    vegan: "Végétalien",
    ...
    dairyFreeDesc: "Sans lait, fromage, beurre, oeufs",
    diabetes: "Diabète",
