...
export const translations = {
  en: {
    ...
    readyToCookDesc: "Scan a photo or add ingredients manually, then generate five recipe ideas ranked by ingredient fit and preferences. Always verify allergens, nutrition, and food safety before cooking.",
