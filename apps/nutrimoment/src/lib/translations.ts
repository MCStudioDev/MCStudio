...
export const translations = {
  en: {
    ...
    premiumPlanScanner: "Premium plan: API recipe generation and scans are enabled with offline fallback. Recipe photos use free public lookups.",
    ...
    premiumMealPlanNotice: "Premium weekly plans use API generation first and offline catalog recipes if the API is unavailable.",
