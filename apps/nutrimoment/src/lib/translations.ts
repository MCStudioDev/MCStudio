...
export const translations = {
  en: {
    ...
    premiumPlanScanner: "Premium plan: API recipe generation and scans are enabled with shared-pool fallback. Recipe photos are generated through Replicate.",
    ...
    premiumPantryNotice: "Premium plan: pantry image scans are API-first with manual fallback.",
